    ...
    <header className="sticky top-0 z-[100] bg-[#0f0f0f] border-b border-white/5 py-4 px-6 md:px-12 flex items-center justify-between shadow-2xl transition-all duration-300">
      <div className="container mx-auto flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6 shrink-0">
          ...
          <div className="flex items-center gap-4 lg:gap-6 border-l border-white/5 pl-6">
            <NotificationBell />
            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                ...
                <div className="flex items-center gap-2 pr-2">
                  <span className="hidden sm:inline-block text-[11px] font-black uppercase tracking-widest text-white/90 group-hover:text-white transition-colors">
