        ...
        <div className="w-full flex items-center justify-start gap-8 lg:gap-12">
          ...
          <Link to="/" className="flex items-center gap-3 group shrink-0">
            ...
            <div className="flex flex-col -space-y-2 py-1">
              <span className="text-xl md:text-2xl font-black tracking-tighter text-white leading-none">JOGOS</span>
              <span className="text-xl md:text-2xl font-black tracking-tighter text-[#ff0000] leading-none">GRATIS</span>
            </div>
          </Link>
