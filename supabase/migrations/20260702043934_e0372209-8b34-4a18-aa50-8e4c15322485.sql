...
CREATE OR REPLACE VIEW public.merged_repacks AS
SELECT base_key,
    ...
    (array_agg(screenshots ORDER BY (upload_date IS NULL), s.upload_date DESC) FILTER (WHERE screenshots IS NOT NULL))[1] AS screenshots,
