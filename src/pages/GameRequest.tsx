    ...
    <div className="min-h-screen bg-[#070707] text-white">
      ...
      <main className="container mx-auto px-4 py-20">
        <motion.div 
          ...
          className="max-w-2xl mx-auto space-y-8 bg-white/5 p-8 md:p-12 rounded-3xl border border-white/10 backdrop-blur-xl shadow-2xl relative overflow-hidden"
        >
          {/* Background Decoration */}
          <div className="absolute -top-24 -right-24 w-48 h-48 bg-primary/20 blur-[100px] rounded-full" />
          <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-primary/10 blur-[100px] rounded-full" />
          ...
          {!isVip ? (
            <div className="bg-black/40 border border-white/10 rounded-2xl p-8 text-center space-y-6 relative overflow-hidden group">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-bold text-white uppercase tracking-wider">Acesso Restrito</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative">
              <div className="space-y-2">
                <label className="text-sm font-bold uppercase tracking-wider text-gray-400 ml-1">Nome do Jogo</label>
                <input
                  required
                  type="text"
                  placeholder="Ex: Elden Ring, GTA V..."
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white placeholder:text-white/20 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold uppercase tracking-wider text-gray-400 ml-1">DLC (Opcional)</label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold uppercase tracking-wider text-gray-400 ml-1">Seu Nick de Usuário</label>
                <input
                  required
                  type="text"
