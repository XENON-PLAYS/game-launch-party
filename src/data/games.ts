...
export const games: Game[] = [
  {
    ...
    categorias: ["Ação","Aventura"], "Aventura"], "Aventura", "Mundo Aberto"],
    modos: ["Singleplayer", "Multiplayer"],
    idiomas: ["Português", "Inglês"],
    descricao: "Arthur Morgan e a gangue Van der Linde são forçados a fugir. Com agentes federais e caçadores de recompensas no seu encalço, a gangue precisa roubar, assaltar e lutar para sobreviver no impiedoso coração dos Estados Unidos.", a gangue precisa roubar, assaltar e lutar para sobreviver no impiedoso coração dos Estados Unidos.", 1899. O fim da era do velho oeste começou.",,
    requisitos: {
  ...
  },
  {
    id: 2,
    nome: "Elden Ring", 
    distribuidor: "FromSoftware, Inc., Bandai Namco Entertainment", Inc., Bandai Namco Entertainment", 
    desenvolvedor: "FromSoftware, Inc.", Inc.", 
  ...
  },
  {
    ...
    descricao: "Mas então, fez-se o fogo. Experimente novamente o jogo aclamado pela crítica e definidor de gênero que foi o início tudo. Belamente remasterizado, volte a Lordran com detalhes em alta definição a 60fps.", fez-se o fogo. Experimente novamente o jogo aclamado pela crítica e definidor de gênero que foi o início tudo. Belamente remasterizado, volte a Lordran com detalhes em alta definição a 60fps.", 
    distribuidor: "FromSoftware, Inc., Bandai Namco Entertainment", Inc., Bandai Namco Entertainment", 
    desenvolvedor: "QLOC, FromSoftware, Inc.", FromSoftware, Inc.", 
  ...
  },
  {
    id: 4,
    nome: "Dark Souls 3", 
    descricao: "DARK SOULS™ II: Scholar of the First Sin leva a renomada obscuridade e jogabilidade viciante da franquia a um novo nível. Junte-se à jornada sombria e vivencie encontros com inimigos devastadores, perigos diabólicos e o desafio implacável.", perigos diabólicos e o desafio implacável.", 
    distribuidor: "Bandai Namco Entertainment, FromSoftware, Inc.", FromSoftware, Inc.", 
    desenvolvedor: "FromSoftware, Inc.", Inc.", 
  ...
  },
  {
    ...
    descricao: "Um vírus maligno toma conta dos residentes de Raccoon City em setembro de 1998, afundando a cidade no caos enquanto zumbis comedores de carne humana vagam pelas ruas em busca de sobreviventes. Um surto de adrenalina sem comparação, uma história instigante e horrores inimagináveis o aguardam.", afundando a cidade no caos enquanto zumbis comedores de carne humana vagam pelas ruas em busca de sobreviventes. Um surto de adrenalina sem comparação, uma história instigante e horrores inimagináveis o aguardam.", 
    distribuidor: "CAPCOM Co., Ltd.", Ltd.", 
    desenvolvedor: "CAPCOM Co., Ltd.", Ltd.", 
  ...
  },
  {
    ...
    descricao: "Jill Valentine é uma das últimas pessoas em Raccoon City a testemunhar as atrocidades que a Umbrella cometeu. Para pará-la a Umbrella libera sua arma secreta suprema: Nemesis! Também inclui a Resident Evil Resistance, um novo modo de jogo multijogador online 4x1.", um novo modo de jogo multijogador online 4x1.", 
    distribuidor: "CAPCOM Co., Ltd.", Ltd.", 
    desenvolvedor: "CAPCOM Co., Ltd.", Ltd.", 
  ...
  },
  {
    ...
    descricao: "Vivencie o horror de sobrevivência como nunca na 8ª sequência parte da franquia Resident Evil - Resident Evil Village. Com gráficos detalhados, ação intensa em primeira pessoa e uma narrativa primorosa, o terror nunca foi tão realista.", ação intensa em primeira pessoa e uma narrativa primorosa, o terror nunca foi tão realista.", 
    distribuidor: "CAPCOM Co., Ltd.", Ltd.", 
    desenvolvedor: "CAPCOM Co., Ltd.", Ltd.", 
  ...
  },
  {
    id: 8,
    nome: "Cyberpunk 2077", 
    descricao: "Cyberpunk 2077 é um RPG de ação e aventura em mundo aberto que se passa em Night City, uma megalópole perigosa onde todos são obcecados por poder, glamour e alterações corporais.", uma megalópole perigosa onde todos são obcecados por poder, glamour e alterações corporais.", 
  ...
  },
  {
    id: 9,
    nome: "GTA V", 
    descricao: "Grand Theft Auto V para PC oferece aos jogadores a opção de explorar o gigantesco e premiado mundo de Los Santos e Blaine County em resoluções de até 4K e além, assim como a chance de experimentar o jogo rodando a 60 FPS (quadros por segundo).", assim como a chance de experimentar o jogo rodando a 60 FPS (quadros por segundo).", 
    distribuidor: "Rockstar Games", 
  ...
  },
  {
    id: 10,
    nome: "The Witcher 3", 
    descricao: "Você é Geralt de Rívia, mercenário matador de monstros. Você está em um continente devastado pela guerra e infestado de monstros para você explorar à vontade. Sua tarefa é encontrar Ciri, a Criança da Profecia — uma arma viva que pode alterar a forma do mundo.", mercenário matador de monstros. Você está em um continente devastado pela guerra e infestado de monstros para você explorar à vontade. Sua tarefa é encontrar Ciri, a Criança da Profecia — uma arma viva que pode alterar a forma do mundo.", 
    distribuidor: "CD PROJEKT RED", 
    desenvolvedor: "CD PROJEKT RED", 
  ...
  },
  {
    ...
    categorias: ["Casual","Indie","Simulação"], "Indie", "Simulação"], "Indie"],
    modos: ["Singleplayer", "Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    descricao: "Gather your party, and return to the Forgotten Realms in a tale of fellowship and betrayal, sacrifice and survival, and the lure of absolute power.", and return to the Forgotten Realms in a tale of fellowship and betrayal, sacrifice and survival, and the lure of absolute power.", 
    ...
    categorias: ["Aventura","RPG","Estratégia"], "RPG", "Estratégia"], "Estratégia"],
    modos: ["Singleplayer", "Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    descricao: "A experiência Call of Duty® é compatível com Call of Duty®: Black Ops 7, Call of Duty®: Black Ops 6 e Call of Duty®: Warzone™.", Call of Duty®: Black Ops 6 e Call of Duty®: Warzone™.", 
    distribuidor: "Activision", 
    desenvolvedor: "Treyarch, Raven Software, Beenox, High Moon Studios, Sledgehammer Games, Infinity Ward, Activision Shanghai, Demonware", Raven Software, Beenox, High Moon Studios, Sledgehammer Games, Infinity Ward, Activision Shanghai, Demonware", 
  ...
  },
  {
    ...
    categorias: ["Ação","Aventura","RPG"], "Aventura", "RPG"], "Mundo Aberto"],
    modos: ["Singleplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    id: 17,
    nome: "Sekiro", 
    descricao: "Fall Guys é um jogo party royale gratuito, multiplataforma e multijogador. Dispute com seus amigos em pistas de obstáculos desajeitadas e absurdas ou construa seu próprio percurso caótico para compartilhar com a comunidade.", multiplataforma e multijogador. Dispute com seus amigos em pistas de obstáculos desajeitadas e absurdas ou construa seu próprio percurso caótico para compartilhar com a comunidade.", 
    desenvolvedor: "Mediatonic", 
    lancamento: "3/ago./2020",
    preco: 0,
    imagem: "https://cdn.cloudflare.steamstatic.com/steam/apps/1097150/header.jpg",
    categorias: ["Ação","Casual","Indie","Multijogador Massivo","Esportes"], "Casual", "Indie", "Multijogador Massivo", "Esportes"], "Soulslike"],
    modos: ["Singleplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    descricao: "Jogo do Ano - The Game Awards 2019 Melhor Jogo de Ação de 2019 - IGN Trilhe seu próprio caminho de vingança nesta premiada aventura da FromSoftware, os criadores de Bloodborne e da franquia Dark Souls. Obtenha vingança. Retome sua honra. Mate astuciosamente.", os criadores de Bloodborne e da franquia Dark Souls. Obtenha vingança. Retome sua honra. Mate astuciosamente.", 
    distribuidor: "Activision (Excluding Japan and Asia), FromSoftware, Inc. (Japan), 方块游戏 (Asia)", FromSoftware, Inc. (Japan), 方块游戏 (Asia)", 
    desenvolvedor: "FromSoftware, Inc.", Inc.", 
    ...
    categorias: ["Ação","Aventura"], "Aventura"], "Soulslike"],
    modos: ["Singleplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    descricao: "O melhor caçador de demônios está de volta com estilo, no jogo que os fãs de ação estavam esperando.", no jogo que os fãs de ação estavam esperando.", 
    distribuidor: "CAPCOM Co., Ltd.", Ltd.", 
    desenvolvedor: "CAPCOM Co., Ltd.", Ltd.", 
  ...
  },
  {
    ...
    categorias: ["Ação","Aventura"], "Aventura"], "Plataforma"],
  ...
  },
  {
    ...
    descricao: "Rainbow Six® Siege é a referência em jogos de tiro táticos. Triunfa quem planejar e executar melhor a estratégia. Aproveite o Acesso Gratuito aos modos de jogo Partida Rápida, Sem Colocação e Dual Front, com uma seleção de agentes.", Sem Colocação e Dual Front, com uma seleção de agentes.", 
    ...
    categorias: ["Ação","Gratuitos para Jogar"], "Gratuitos para Jogar"], "Tático"],
    modos: ["Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    id: 23,
    nome: "Apex Legends", 
    descricao: "Apex Legends é o premiado jogo de tiro em primeira pessoa de heróis e heroínas da Respawn Entertainment. Domine um elenco cada vez mais amplo de personagens lendários com habilidades poderosas, experimente partidas estratégicas e a jogabilidade inovadora na próxima evolução do gênero battle royale.", experimente partidas estratégicas e a jogabilidade inovadora na próxima evolução do gênero battle royale.", 
    distribuidor: "Electronic Arts", 
    desenvolvedor: "Respawn", 
    lancamento: "4/nov./2020",
    preco: 0,
    imagem: "https://cdn.cloudflare.steamstatic.com/steam/apps/1172470/header.jpg",
    categorias: ["Ação","Aventura","Gratuitos para Jogar"], "Aventura", "Gratuitos para Jogar"], "FPS"],
    modos: ["Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    categorias: ["Ação","Aventura","Casual"], "Aventura", "Casual"], "Mundo Aberto"],
    modos: ["Singleplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    categorias: ["Ação","Aventura"], "Aventura"], "Ação"],
    modos: ["Singleplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    descricao: "Essa é a experiência definitiva de Battlefield V. Entre no maior conflito da humanidade com o arsenal completo de armas, veículos e dispositivos, além do melhor conteúdo de personalização dos Anos 1 e 2.", veículos e dispositivos, além do melhor conteúdo de personalização dos Anos 1 e 2.", 
    distribuidor: "Electronic Arts", 
    desenvolvedor: "DICE", 
  ...
  },
  {
    ...
    categorias: ["Ação","Aventura","Casual"], "Aventura", "Casual"], "Ação"],
    modos: ["Singleplayer", "Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    id: 29,
    nome: "PUBG", 
    descricao: "PUBG: BATTLEGROUNDS, o jogo de tiro de alto risco em que o vencedor leva tudo e que deu início ao fenômeno do Battle Royale, é gratuito! Entre em diversos mapas, saqueie armas e suprimentos exclusivos e sobreviva em uma zona cada vez menor, onde cada turno pode ser o último.", o jogo de tiro de alto risco em que o vencedor leva tudo e que deu início ao fenômeno do Battle Royale, é gratuito! Entre em diversos mapas, saqueie armas e suprimentos exclusivos e sobreviva em uma zona cada vez menor, onde cada turno pode ser o último.", 
    distribuidor: "KRAFTON, Inc.", Inc.", 
    ...
    categorias: ["Ação","Aventura","Multijogador Massivo","Gratuitos para Jogar"], "Aventura", "Multijogador Massivo", "Gratuitos para Jogar"], "FPS"],
    modos: ["Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    id: 30,
    nome: "Halo MCC", 
    descricao: "A lendária jornada do Master Chief está incluída em seis jogos, feitos para PC e reunidos em uma única experiência. Tanto para fãs de longa data como para os que conhecerão o Spartan 117 agora, a Master Chief Collection é a experiência de jogo definitiva da série Halo.", feitos para PC e reunidos em uma única experiência. Tanto para fãs de longa data como para os que conhecerão o Spartan 117 agora, a Master Chief Collection é a experiência de jogo definitiva da série Halo.", 
    distribuidor: "Xbox Game Studios", 
    desenvolvedor: "343 Industries, Splash Damage, Ruffian Games, Bungie, Saber Interactive", Splash Damage, Ruffian Games, Bungie, Saber Interactive", 
  ...
  },
  {
    ...
    descricao: "De uma das sagas mais icônicas dos jogos, Halo está maior do que nunca. Com uma campanha expansiva de mundo aberto e uma experiência de multijogador dinâmica e gratuita. ", Halo está maior do que nunca. Com uma campanha expansiva de mundo aberto e uma experiência de multijogador dinâmica e gratuita. ", 
    distribuidor: "Xbox Game Studios", 
    ...
    categorias: ["Ação","Gratuitos para Jogar"], "Gratuitos para Jogar"], "RPG"],
    modos: ["Singleplayer", "Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    descricao: "Encare o desafio e junte-se à caça! Em Monster Hunter Rise, o capítulo mais recente da premiada e bem-sucedida série Monster Hunter, você vai se tornar um caçador, explorar mapas novos e usar diversas armas para derrotar monstros assustadores como parte de uma nova história.", o capítulo mais recente da premiada e bem-sucedida série Monster Hunter, você vai se tornar um caçador, explorar mapas novos e usar diversas armas para derrotar monstros assustadores como parte de uma nova história.", 
    distribuidor: "CAPCOM Co., Ltd.", Ltd.", 
    desenvolvedor: "CAPCOM Co., Ltd.", Ltd.", 
  ...
  },
  {
    ...
    descricao: "Cities: Skylines é uma versão moderna dos simuladores de cidade clássicos. O jogo introduz novos elementos de jogabilidade para que você sinta a emoção e a dificuldade de criar e manter uma cidade de verdade, além de aprimorar os elementos clássicos da construção de cidades. ", além de aprimorar os elementos clássicos da construção de cidades. ", 
    ...
    categorias: ["Simulação","Estratégia"], "Estratégia"], "Estratégia"],
    modos: ["Singleplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    id: 38,
    nome: "Stardew Valley", 
    descricao: "Você herdou a antiga fazenda do seu avô, em Stardew Valley. Com ferramentas de segunda-mão e algumas moedas, você parte para dar início a sua nova vida. Será que você vai aprender a viver da terra, a transformar esse matagal em um próspero lar?", em Stardew Valley. Com ferramentas de segunda-mão e algumas moedas, você parte para dar início a sua nova vida. Será que você vai aprender a viver da terra, a transformar esse matagal em um próspero lar?", 
    ...
    categorias: ["Indie","RPG","Simulação"], "RPG", "Simulação"], "Indie"],
    modos: ["Singleplayer", "Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    categorias: ["Ação","Indie","Acesso Antecipado"], "Indie", "Acesso Antecipado"], "Multiplayer"],
    modos: ["Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    id: 41,
    nome: "Lost Ark DLC", 
    descricao: "Embarque numa odisseia pela Arca Perdida num mundo vasto e vibrante: explore novas terras, procure tesouros perdidos e teste-se num combate de ação emocionante neste RPG grátis para jogar. ", procure tesouros perdidos e teste-se num combate de ação emocionante neste RPG grátis para jogar. ", 
    ...
    categorias: ["Ação","Aventura","Multijogador Massivo","RPG","Gratuitos para Jogar"], "Aventura", "Multijogador Massivo", "RPG", "Gratuitos para Jogar"], "Ação"],
    modos: ["Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    id: 42,
    nome: "Sea of Thieves", 
    descricao: "Sea of Thieves é um jogo de aventura pirata de sucesso, que oferece a experiência de pilhar tesouros perdidos, fazer parte de batalhas intensas, derrotar monstros marinhos e muito mais. Mergulhe nesta edição revisada do jogo, que inclui acesso a conteúdo digital bônus.", que oferece a experiência de pilhar tesouros perdidos, fazer parte de batalhas intensas, derrotar monstros marinhos e muito mais. Mergulhe nesta edição revisada do jogo, que inclui acesso a conteúdo digital bônus.", 
    distribuidor: "Xbox Game Studios", 
    desenvolvedor: "Rare Ltd", 
    lancamento: "3/jun./2020",
    preco: 0,
    imagem: "https://cdn.cloudflare.steamstatic.com/steam/apps/1172620/header.jpg",
    categorias: ["Ação","Aventura"], "Aventura"], "Multiplayer"],
    modos: ["Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    descricao: "Vencedor de mais de 200 prémios de Jogo do Ano, The Elder Scrolls V: Skyrim Special Edition dá vida à fantasia épica com um nível de detalhe espantoso. A Special Edition inclui o jogo aclamado pela crítica e suplementos com novas funcionalidades.", The Elder Scrolls V: Skyrim Special Edition dá vida à fantasia épica com um nível de detalhe espantoso. A Special Edition inclui o jogo aclamado pela crítica e suplementos com novas funcionalidades.", 
    distribuidor: "Bethesda Softworks", 
    desenvolvedor: "Bethesda Game Studios", 
  ...
  },
  {
    ...
    categorias: ["Ação","Aventura"], "Aventura"], "Aventura"],
    modos: ["Singleplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
  ...
  },
  {
    ...
    descricao: "O FIFA 23 leva o Jogo de Todo Mundo aos gramados com a tecnologia HyperMotion2, FIFA World Cup™ masculina e feminina, clubes femininos, recursos de crossplay** e muito mais.", FIFA World Cup™ masculina e feminina, clubes femininos, recursos de crossplay** e muito mais.", 
    distribuidor: "Electronic Arts", 
    desenvolvedor: "EA Canada, EA Romania", EA Romania", 
    ...
    categorias: ["Simulação","Esportes"], "Esportes"], "Simulação"],
    modos: ["Singleplayer", "Multiplayer"],
    idiomas: ["Português", "Inglês"],,
    requisitos: {
