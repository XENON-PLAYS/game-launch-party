        ...
        >
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed text-sm md:text-base">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-foreground uppercase tracking-wider">Remoção de Conteúdo</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-foreground uppercase tracking-wider">Uso do Site</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-foreground uppercase tracking-wider">Propriedade Intelectual</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-foreground uppercase tracking-wider">Cookies</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-foreground uppercase tracking-wider">Isenção de Responsabilidade</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-foreground uppercase tracking-wider">Lei Aplicável</h2>
              <p>
