        ...
        >
          ...
          <div className="space-y-8 text-gray-400 leading-relaxed text-sm md:text-base">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-white uppercase tracking-wider">1. Coleta de Informações</h2>
              <p>A coleta de informações ocorre de forma limitada e pode incluir:</p>
              
              <div className="ml-4 space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-white/90">1.1 Dados de Navegação (Anônimos)</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white/90">1.2 Conteúdo Fornecido pelo Usuário</h3>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-white uppercase tracking-wider">2. Uso das Informações</h2>
              ...
              <p className="font-semibold text-white/90">Não comercializamos, alugamos ou compartilhamos dados pessoais com terceiros, salvo quando exigido por lei.</p>
            </section>

            <section className="space-y-4">
              <h2 className="text-xl font-bold text-white uppercase tracking-wider">3. Armazenamento e Segurança</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-white uppercase tracking-wider">4. Cookies e Tecnologias Semelhantes</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-white uppercase tracking-wider">5. Direitos do Usuário</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-bold text-white uppercase tracking-wider">6. Alterações nesta Política</h2>
            ...
            <section className="space-y-4 border-t border-white/10 pt-8">
              <h2 className="text-xl font-bold text-white uppercase tracking-wider">7. Contato</h2>
